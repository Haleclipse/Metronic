    ...
    children: [
      {
        path: "/dashboard",
        name: "dashboard",
        component: () => import("@/views/apps/devs/Tag.vue"),
      },
      {
        path: "/builder",
        name: "builder",
      ...
      },
      {
        path: "/apps/devs/ask",
        name: "apps-devs-ask",
        component: () => import("@/views/apps/devs/Ask.vue"),
      },
      {
        path: "/apps/devs/question",
        name: "apps-devs-question",
        component: () => import("@/views/apps/devs/Question.vue"),
      },
      {
        path: "/apps/devs/search",
        name: "apps-devs-search",
        component: () => import("@/views/apps/devs/Search.vue"),
      },
      {
        path: "/apps/devs/tag",
        name: "apps-devs-tag",
