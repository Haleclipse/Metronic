<template>
  ...
  <div class="mb-0">
    ...
    <div class="fs-4 fw-normal text-gray-800 mb-10">
      ...
      <p>
        I’ve been doing some ajax request, to populate a inside drawer, the
        content of that drawer has a sub menu, that you are using in list and
        all card toolbar.
      </p>

      <p>
        But they are not displaying, since it is an ajax, I tried
        “KTApp.init();” but didn’t work (worked for Tooltips sure, but not
        Menu).
      </p>
    ...
    <div class="d-flex flex-stack flex-wrap">
      ...
      <div class="d-flex align-items-center py-1">
        ...
        >
          <span class="text-gray-800 fs-7 fw-semobold lh-1 mb-2"
            >James Hunt</span
          >
          <span class="text-muted fs-8 fw-semobold lh-1">24 minutes ago</span>
        </div>
        <!--end::Name-->
      </div>
      <!--end::Author-->
      ...
      <div class="d-flex align-items-center py-1">
        ...
        <a href="#" class="btn btn-sm btn-light px-4 me-2"> Laravel </a>

        <a href="#>" class="btn btn-sm btn-light px-4 me-2"> Metronic </a>
        ...
        <a
          href="#"
          class="btn btn-sm btn-flex btn-light px-4"
          data-bs-toggle="tooltip"
  ...
  <form id="kt_devs_reply_form" class="form mb-10" action="#">
    ...
    <div class="d-flex align-items-center justify-content-between py-2 mb-5">
      ...
      <div
        class="text-primary fs-base fw-semobold cursor-pointer"
      ...
      <!--begin::Submit-->
      <button class="btn btn-primary fw-bold" data-kt-action="submit">
        Submit
      </button>
      <!--end::Submit-->
    </div>
...
import TextFormatting from "@/components/devs/TextFormatting";
import LayoutService from "@/core/services/LayoutService";
import { setCurrentPageTitle } from "@/core/helpers/breadcrumb";
import Replies from "@/components/devs/Replies";
